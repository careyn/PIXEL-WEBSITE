...
This is a website I made for one of my friends who sells jewellery on depop.  It dynamically shows stock using php, reading from an SQL database.
Purchasing is made possible through the use of a price-calculating form (javascript calculator + validation), and paypal payment processing button.
